...
import { Modal, Pressable, StyleSheet, Text, View, TouchableOpacity, Platform, Image } from 'react-native'
      ...
      <Modal visible={isOpen} transparent animationType="fade">
        <Pressable style={styles.overlay} onPress={() => setIsOpen(false)}>
          <View style={[styles.dropdown, Platform.OS === 'web' && { boxShadow: '0px 4px 12px rgba(0,0,0,0.1)' }]}>
            ...
            {/* Profile header — navigates to Profile screen */}
            <TouchableOpacity style={styles.profileHeader} onPress={() => handleNavigate('/profile')}>
              {user?.avatar_url ? (
